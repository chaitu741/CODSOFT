...
titanic_df = pd.read_csv(r"C:\Users\chaitanya pingale\Downloads\Titanic-Dataset.csv")
...
cv_results['param_n_estimators'] = cv_results['param_n_estimators'].astype(str)
cv_results['param_max_depth'] = cv_results['param_max_depth'].astype(str)

plt.figure(figsize=(10, 6))
sns.barplot(x='param_n_estimators', y='mean_test_score', hue='param_max_depth', data=cv_results,
            palette=['blue', 'red', 'black'],  # Adjusted to include enough colors
            dodge=True, edgecolor='black', linewidth=1.5, capsize=0.1, err_kws={'linewidth': 1.5})
...
titanic_test_data = pd.read_csv(r'C:\Users\chaitanya pingale\Downloads\test.csv')
...
final_df.to_csv(path_or_buf=r"C:\Users\chaitanya pingale\Downloads\result.csv",index=False)
